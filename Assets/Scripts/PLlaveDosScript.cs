...
public class PLlaveDosScript : MonoBehaviour
{
    ...
    public int linkPLlaveDosId; // id para linkear la puerta con el trigger

    // Start is called before the first frame update
    void Start()
    {
        EventoManagerScript.instanciar.abrirPuertaLlaveDosEvento += Abrir;
    }
    ...
    {
        if (linkPortonId == linkPLlaveDosId) // si el link del trigger es igual al link de la puerta
        {
    ...
    {
        EventoManagerScript.instanciar.abrirPuertaLlaveDosEvento -= Abrir; // de desuscribe al evento
    }
}
