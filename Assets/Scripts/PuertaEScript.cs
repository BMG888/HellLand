...
public class PuertaEScript : MonoBehaviour
{
    ...
    void Start()
    {
        EventoManagerScript.instanciar.abrirPuertaElectricaEvento += Abrir; // se suscribe la puerta al evento
    }
    ...
    {
        EventoManagerScript.instanciar.abrirPuertaElectricaEvento -= Abrir; // de desuscribe al evento
    }       
}
